...
import { SidebarLeftIcon as PanelLeftIcon } from "hugeicons-react";
...
export function SidebarMenuSkeleton({
  ...
  // Width between 50 and 90%, derived from useId so it varies per row without
  // calling an impure function during render (react-hooks/purity).
